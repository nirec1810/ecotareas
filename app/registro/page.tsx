        ...
        <form action={action} className="space-y-4">
          <div>
            ...
            <input
              ...
              type="text"
              autoComplete="name"
              className={`w-full px-3 py-2 border rounded text-sm ${errors?.full_name ? 'border-red-500' : 'border-gray-300'} focus:outline-none focus:ring-2 focus:ring-green-500`}
            />
            {errors?.full_name && (
              <p className="mt-1 text-xs text-red-600">{errors.full_name[0]}</p>
            )}
            {errors?.['full_name'] && (
              <p className="mt-1 text-xs text-red-600">{(errors as any)['full_name'][0]}</p>
            )}
          </div>
          ...
          <div>
            ...
            <input
              ...
              type="email"
              autoComplete="email"
              className={`w-full px-3 py-2 border rounded text-sm ${errors?.email ? 'border-red-500' : 'border-gray-300'} focus:outline-none focus:ring-2 focus:ring-green-500`}
            />
            {errors?.email && (
          ...
          <div>
            ...
            <input
              ...
              className={`w-full px-3 py-2 border rounded text-sm ${errors?.password ? 'border-red-500' : 'border-gray-300'} focus:outline-none focus:ring-2 focus:ring-green-500`}
            />
            {errors?.password && (
          ...
          <div>
            ...
            <input
              ...
              type="password"
              autoComplete="new-password"
              className={`w-full px-3 py-2 border rounded text-sm ${errors?.confirmar_password ? 'border-red-500' : 'border-gray-300'} focus:outline-none focus:ring-2 focus:ring-green-500`}
            />
